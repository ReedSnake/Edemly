    ...
    public partial class Page_main
    {
        private void OnPaste(object sender, DataObjectPastingEventArgs e)
        {
            try
            {
                ...
                if (Page_main_AttachmentInputHelper.HasFiles(clipboardData))
                {
                    e.CancelCommand();
                    _ = RunAttachmentSelectionAsync(Page_main_AttachmentInputHelper.ExtractFiles(clipboardData));
                    return;
                }
        ...
        private void OnPasteCommandExecuted(object sender, ExecutedRoutedEventArgs e)
        {
            try
            {
                ...
                var clipboardText = Page_main_AttachmentInputHelper.ExtractText(clipboardData);
