    ...
    public partial class CallWindow : Window
    {
        ...
        private async Task LoadActiveCallsAsync()
        {
            ...
            try
            {
                ...
                {
                    CallsListPanel.Children.Add(new TextBlock { Text = DefaultLanguage.NoActiveCall, Margin = new Thickness(6) }); // ? ������������
                    return;
                }
            ...
            {
                CallsListPanel.Children.Add(new TextBlock { Text = $"{DefaultLanguage.Loading} {ex.Message}", Margin = new Thickness(6) }); // ? ������������
            }
        }
